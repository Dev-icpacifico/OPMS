...
from gestion_contable.admin import PagosInline  # Reutilizamos el inline de Pagos
...
class VentaAdmin(admin.ModelAdmin):
    list_display = ('id_venta', 'id_propiedad', 'id_cliente', 'fecha_venta', 'fecha_promesa', 'ejecutivo')
    list_filter = ('fecha_venta', 'ejecutivo')
    search_fields = ('id_propiedad__numero_propiedad', 'id_cliente__rut_cliente', 'ejecutivo')
