...
class Propiedade(models.Model):
    ...
    valor_estacionamiento = models.IntegerField(verbose_name="Valor", help_text="Valor Estacionamiento", default=0)
    rol_estacionamiento = models.CharField(verbose_name="Rol", help_text="Rol Estacionamiento", max_length=50)
    bodega = models.CharField(verbose_name="Bdg", help_text="N° Bodega", max_length=5)
    valor_bodega = models.CharField(verbose_name="Valor", help_text="Valor Bodega", max_length=50)
    rol_bodega = models.CharField(verbose_name="Rol", help_text="Rol Bodega", max_length=50)
