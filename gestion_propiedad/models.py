...
class Propiedade(models.Model):
    ...
    valor_estacionamiento = models.FloatField(verbose_name="Valor", help_text="Valor Estacionamiento", default=0)
    ...
    valor_bodega = models.FloatField(verbose_name="Valor", help_text="Valor Bodega")
